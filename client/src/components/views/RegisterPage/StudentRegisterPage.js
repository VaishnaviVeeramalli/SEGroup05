...
import { studentRegister } from "../../../Actions/actions";
          ...
          return (
            <Form className="container">
              ...
              <div className="form-control row">
                ...
                <br />
                <Field placeholder="studentID" type="number" id="studentID" name="studentID"></Field>
              ...
              <div className="form-control row">
                ...
                <br />
                <Field placeholder="phone" type="number" id="phone" name="phone"></Field>
              ...
              <div className="form-control row">
                ...
                <br />
                <Field placeholder="address" type="string" id="address" name="address"></Field>
